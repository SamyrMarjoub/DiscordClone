    ...
    return (
      <>
        ...
        <div className='w-full h-[100vh] flex flex-col items-center'>
          ...
          <div className='w-full h-[53px] flex justify-center border-b border-b-[#18191C]'>
            <div className='w-[98%] flex items-center h-full'>
              ...
              <div className='w-[50%] flex justify-end'>
                <div className='w-[400px] items-center flex justify-between h-full'>
                  <div className='h-full flex   tablets2:w-[20px] items-center'>
                 ...
                 9H3.55274C3.47819 9 3.42168 8.93274 3.43453 8.85931L3.74253
                  ...
                  <div className='h-full flex justify-center tablets2:w-[20px] items-center w-[40px]'>
                    <IoIosNotifications className='text-[25px] text-[#B9BBBE]' />
                  </div>
                  <div className='h-full flex tablets2:w-[20px] justify-center items-center w-[40px]'>
                    <svg x="0" y="0" className="icon-2xnN2Y"
                  ...
                  <div className='h-full tablets2:w-[20px] flex justify-center items-center w-[40px]'>
          ...
          {/* Main */}
          <div className='w-[98%] h-[70%] flex flex-col justify-between flex-1'>
            {twomsg.length === 0 ? <>
              ...
              <div className='w-full  flex flex-col justify-end h-full'>
                <div className='w-full border-t pt-[25px] scrollbar scrollbar-thumb-gray-900 scrollbar-track-gray-100  overflow-auto border-t-[#4F545C99]'>
          ...
          <div className='w-[98%] flex justify-center'>
            <div className='min-h-[90px] relative flex justify-center items-center w-full'>
              ...
              <div className='bg-[#40444B] flex h-[45px] rounded-md w-full'>
                ...
                <div className='w-[60px] h-full flex justify-center items-center text-[25px]'>
                  <IoMdAddCircle onClick={handleSubmitFile} cursor={'pointer'} className='text-[#B9BBBE]' />
                  <input id='input' onChange={(e) => readFile(e)} type={"file"} className="hidden" />
                </div>
